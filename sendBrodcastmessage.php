<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div><span style="font-size:30px; cursor:pointer;color: black;color: black;" 
       ...
       <p> Enter Date:  <input type="text" name="date3" id="date1"></p>
        <p>Brodcast Message<br>
        To,<br>
        Class 6B<br>
        Date:<br></p>
  
        <textarea type="text" name="brodcast" placeholder="Enter the Message Here:-"id="Brodcast" ></textarea>
        <p>Upload Maximum 4 picture</p><input type="file" name="file" id="file2">
        <p>Thanks,<br>
         <?php
           echo $_SESSION['username'];
              ?></p>
        <input type="submit" name="sub2" id="button1">
